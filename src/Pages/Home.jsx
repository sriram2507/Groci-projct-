...
const Home = () => {
    return (
        ...
        <div className='offercontent'>
            <div className='outerbox1'><img src="basket-full-vegetables.jpg" width={'450px'} height={'300px'}></img><div className='offertitle'>Vegtable's Combo</div><p className='offersubcnt'>All type of vegetables available at <b> 10% </b> Save.</p></div>
            <div className='outerbox1'><img src="fruits-basket.jpg" width={'450px'} height={'300px'}></img><div className='offertitle'>Fruit's Combo</div><p className='offersubcnt'>All type of fruits available at <b> 10% </b> Save.</p></div>
